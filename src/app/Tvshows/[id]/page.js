 ...
 if (score >= 80) return ["😍", "😊", "🔥"];
  ...
  return (
   ...
   <div className="flex flex-wrap gap-4 text-xl py-5"> 
          <p className="basis-full sm:basis-1/2 md:basis-auto font-bold">Media</p>
       <button onClick={()=>setActive('popular')} className={` sm:basis-1/2 md:basis-auto ${active === 'popular' ? ' border-0 md:border-b-4  border-b-black' : ""} font-bold cursor-pointer`}>Most popular</button>
        
        <button onClick={()=> setActive('videos')} className={` sm:basis-1/2 md:basis-auto ${active === 'videos' ? "border-0 md:border-b-4 border-b-black" : ""} font-bold cursor-pointer`}>videos</button>

        <button onClick={()=> setActive('backdrops')} className={` sm:basis-1/2 md:basis-auto ${active === 'backdrops' ? "border-0 md:border-b-4 border-b-black" : ""} font-bold cursor-pointer`}>backdrops</button>

        <button onClick={()=> setActive('posters')} className={` sm:basis-1/2 md:basis-auto ${active === 'posters' ? "border-0 md:border-b-4 border-b-black" : ""} font-bold cursor-pointer`}>posters</button>
