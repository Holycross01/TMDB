...
const CustomDropdown = ({ options, active, setActive }) => {
  ...
  return (
    <div className="relative w-full max-w-[150px] sm:hidden">
      ...
      <button
        ...
        className="w-full border border-[#1ed5a9] rounded-tr-lg font-semibold rounded-tl-lg px-3 py-2 bg-gradient-to-r from-[#c0fecf] to-[#1ed5a9] text-black flex justify-between items-center outline-none"
      >
        {active}
  ...
  <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m19 9-7 7-7-7"/>
      ...
      {/* Dropdown menu */}
      {open && (
        <div className="absolute top-full -mt-2  font-semibold  w-full rounded-br-lg rounded-bl-lg bg-gradient-to-r from-[#c0fecf] to-[#1ed5a9] text-black shadow-lg z-50">
